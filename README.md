...
Position the product within the camera frame
The system will analyze the input and display:
Pass: No defect detected
Fail: Defect detected along with classification
System Workflow
...
Contributions are welcome. Please fork the repository and submit a pull request for any improvements or enhancements.
